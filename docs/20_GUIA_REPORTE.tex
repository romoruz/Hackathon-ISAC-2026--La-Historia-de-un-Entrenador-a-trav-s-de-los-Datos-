% 20_GUIA_REPORTE.tex — guía de lectura del informe H7 (ADR-59)
% Compilar desde docs/:
...
\fancyhead[L]{\small Guía de lectura · El América de Jardine}
...
\title{\textbf{El América de Jardine}\\[0.3em]\large Guía de lectura del informe interactivo}
\author{dt-decoder · Hackathon 2026}
\date{Acompaña a \texttt{reporte.html} (ADR-59 y su adenda 1)}
...
La página es una crónica de diez secciones, en el orden de ADR-59 §4. La barra
superior es un índice: cada botón lleva a una sección y el nombre de la sección
activa aparece a su lado. Arriba de todo están las huellas de los insumos: el
commit del código y, para cada JSON, la fecha de su corrida y el inicio de su
sha256. Los JSON de \texttt{reports/} no se versionan; esa huella es la forma de
saber con qué datos se generó la página.
...
Cada frase lleva una etiqueta y una sola.
...
\subsection*{01 · Cómo leer este informe \hfill{\normalfont\small componente 5.6}}
...
\subsection*{02 · El América de Jardine con el balón \hfill{\normalfont\small 5.1 ofensiva}}
...
\subsection*{03 · Sin el balón \hfill{\normalfont\small 5.1 defensiva}}
...
\subsection*{04 · ¿Se sostiene en el tiempo? \hfill{\normalfont\small 5.2 consistencia}}
...
\subsection*{05 · ¿Ajusta al contexto? \hfill{\normalfont\small 5.2 variabilidad}}
...
\subsection*{06 · El plantel \hfill{\normalfont\small 5.3}}
...
\subsection*{07 · Balón parado \hfill{\normalfont\small 5.4}}
...
\subsection*{08 · ¿Qué es de Jardine y qué del América? \hfill{\normalfont\small diferenciador}}
...
\subsection*{09 · ¿El método distingue de verdad? \hfill{\normalfont\small credibilidad}}
...
\subsection*{10 · Framework y límites \hfill{\normalfont\small 5.6}}
